...
{
    /// <inheritdoc />
    public partial class FixDependencyRelation_v2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dependency_Module_SourceModuleID",
                        column: x => x.SourceModuleID,
                        principalTable: "Module",
                        principalColumn: "ModuleID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dependency_Module_TargetModuleID",
            ...
            migrationBuilder.InsertData(
                table: "Technologies",
                columns: new[] { "TechnologyID", "Category", "Description", "Name", "Version" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dependency_SourceModuleID",
                table: "Dependency",
                column: "SourceModuleID");

            migrationBuilder.CreateIndex(
                name: "IX_Dependency_TargetModuleID",
                table: "Dependency",
