...
namespace DependencySystem.API.Migrations
{
    ...
    [Migration("20260202201620_AddProjectTeamMember")]
    partial class AddProjectTeamMember
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DependencySystem.API.Model.ProjectTeamMember", b =>
                {
            ...
            modelBuilder.Entity("DependencySystem.API.Model.TeamMemberProfile", b =>
                {
            ...
            modelBuilder.Entity("Dependency", b =>
                {
                    ...
                    b.HasOne("Module", "SourceModule")
                        .WithMany()
                        .HasForeignKey("SourceModuleID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Module", "TargetModule")
                        .WithMany()
            ...
            modelBuilder.Entity("DependencySystem.API.Model.TeamMemberProfile", b =>
                {
                    b.HasOne("DependencySystem.API.Model.ApplicationUser", "User")
                        ...
                        .HasForeignKey("DependencySystem.API.Model.TeamMemberProfile", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
